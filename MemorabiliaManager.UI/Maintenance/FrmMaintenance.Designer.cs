namespace MemorabiliaManager.UI.Maintenance
{
	partial class FrmMaintenance
	{
		...
		private void InitializeComponent()
		{
			...
			this.tpgAuthenticationService = new System.Windows.Forms.TabPage();
			this.button1 = new System.Windows.Forms.Button();
			this.txtAuthenticationServiceWebsite = new System.Windows.Forms.TextBox();
			this.txtAuthenticationServiceName = new System.Windows.Forms.TextBox();
			this.label23 = new System.Windows.Forms.Label();
			this.label22 = new System.Windows.Forms.Label();
			this.dgvAuthenticationService = new System.Windows.Forms.DataGridView();
			...
			this.tpgEntertainmentCategory = new System.Windows.Forms.TabPage();
			this.chkEntertainmentCategoryIsSport = new System.Windows.Forms.CheckBox();
			this.txtEntertainmentCategoryName = new System.Windows.Forms.TextBox();
			this.label21 = new System.Windows.Forms.Label();
			this.dgvEntertainmentCategory = new System.Windows.Forms.DataGridView();
			...
			this.tpgAuthenticationService.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvAuthenticationService)).BeginInit();
			this.tpgAuthentication.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvAuthentication)).BeginInit();
			this.tpgEntertainmentCategory.SuspendLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvEntertainmentCategory)).BeginInit();
			...
			this.tcMaintenance.Controls.Add(this.tpgAuthenticationService);
			this.tcMaintenance.Controls.Add(this.tpgAuthentication);
			this.tcMaintenance.Controls.Add(this.tpgEntertainmentCategory);
			...
			this.tcMaintenance.SelectedIndexChanged += new System.EventHandler(this.tcMaintenance_SelectedIndexChanged);
			// 
			// tpgAuthenticationService
			// 
			this.tpgAuthenticationService.BackColor = System.Drawing.SystemColors.Control;
			this.tpgAuthenticationService.Controls.Add(this.button1);
			this.tpgAuthenticationService.Controls.Add(this.txtAuthenticationServiceWebsite);
			this.tpgAuthenticationService.Controls.Add(this.txtAuthenticationServiceName);
			this.tpgAuthenticationService.Controls.Add(this.label23);
			this.tpgAuthenticationService.Controls.Add(this.label22);
			this.tpgAuthenticationService.Controls.Add(this.dgvAuthenticationService);
			this.tpgAuthenticationService.Location = new System.Drawing.Point(4, 29);
			this.tpgAuthenticationService.Name = "tpgAuthenticationService";
			this.tpgAuthenticationService.Size = new System.Drawing.Size(843, 485);
			this.tpgAuthenticationService.TabIndex = 6;
			this.tpgAuthenticationService.Text = "Authentication Services";
			// 
			// button1
			// 
			...
			// 
			// txtAuthenticationServiceWebsite
			// 
			this.txtAuthenticationServiceWebsite.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.txtAuthenticationServiceWebsite.Location = new System.Drawing.Point(160, 421);
			this.txtAuthenticationServiceWebsite.Name = "txtAuthenticationServiceWebsite";
			this.txtAuthenticationServiceWebsite.Size = new System.Drawing.Size(383, 27);
			this.txtAuthenticationServiceWebsite.TabIndex = 5;
			// 
			// txtAuthenticationServiceName
			// 
			this.txtAuthenticationServiceName.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.txtAuthenticationServiceName.Location = new System.Drawing.Point(160, 388);
			this.txtAuthenticationServiceName.Name = "txtAuthenticationServiceName";
			this.txtAuthenticationServiceName.Size = new System.Drawing.Size(159, 27);
			this.txtAuthenticationServiceName.TabIndex = 4;
			// 
			// label23
			// 
			this.label23.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.label23.AutoSize = true;
			this.label23.Location = new System.Drawing.Point(7, 424);
			this.label23.Name = "label23";
			this.label23.Size = new System.Drawing.Size(147, 20);
			this.label23.TabIndex = 3;
			this.label23.Text = "Code Check Website:";
			// 
			// label22
			// 
			...
			this.label22.Location = new System.Drawing.Point(7, 391);
			this.label22.Name = "label22";
			this.label22.Size = new System.Drawing.Size(55, 20);
			this.label22.TabIndex = 2;
			this.label22.Text = "Name:";
			// 
			// dgvAuthenticationService
			// 
			this.dgvAuthenticationService.AllowUserToAddRows = false;
			this.dgvAuthenticationService.AllowUserToDeleteRows = false;
			this.dgvAuthenticationService.AllowUserToOrderColumns = true;
			this.dgvAuthenticationService.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.dgvAuthenticationService.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dgvAuthenticationService.Location = new System.Drawing.Point(0, 0);
			this.dgvAuthenticationService.Name = "dgvAuthenticationService";
			this.dgvAuthenticationService.ReadOnly = true;
			this.dgvAuthenticationService.RowHeadersWidth = 51;
			this.dgvAuthenticationService.RowTemplate.Height = 29;
			this.dgvAuthenticationService.Size = new System.Drawing.Size(843, 359);
			this.dgvAuthenticationService.TabIndex = 1;
			// 
			// tpgAuthentication
			// 
			...
			this.dgvAuthentication.Size = new System.Drawing.Size(840, 379);
			this.dgvAuthentication.TabIndex = 9;
			// 
			...
			// 
			// tpgEntertainmentCategory
			// 
			this.tpgEntertainmentCategory.BackColor = System.Drawing.SystemColors.Control;
			this.tpgEntertainmentCategory.Controls.Add(this.chkEntertainmentCategoryIsSport);
			this.tpgEntertainmentCategory.Controls.Add(this.txtEntertainmentCategoryName);
			this.tpgEntertainmentCategory.Controls.Add(this.label21);
			this.tpgEntertainmentCategory.Controls.Add(this.dgvEntertainmentCategory);
			this.tpgEntertainmentCategory.Location = new System.Drawing.Point(4, 29);
			this.tpgEntertainmentCategory.Name = "tpgEntertainmentCategory";
			this.tpgEntertainmentCategory.Size = new System.Drawing.Size(843, 485);
			this.tpgEntertainmentCategory.TabIndex = 5;
			this.tpgEntertainmentCategory.Text = "Entertainment Categories";
			// 
			// chkEntertainmentCategoryIsSport
			// 
			this.chkEntertainmentCategoryIsSport.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.chkEntertainmentCategoryIsSport.AutoSize = true;
			this.chkEntertainmentCategoryIsSport.Location = new System.Drawing.Point(240, 420);
			this.chkEntertainmentCategoryIsSport.Name = "chkEntertainmentCategoryIsSport";
			this.chkEntertainmentCategoryIsSport.Size = new System.Drawing.Size(81, 24);
			this.chkEntertainmentCategoryIsSport.TabIndex = 4;
			this.chkEntertainmentCategoryIsSport.Text = "Is Sport";
			this.chkEntertainmentCategoryIsSport.UseVisualStyleBackColor = true;
			// 
			// txtEntertainmentCategoryName
			// 
			this.txtEntertainmentCategoryName.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left)));
			this.txtEntertainmentCategoryName.Location = new System.Drawing.Point(67, 417);
			this.txtEntertainmentCategoryName.MaxLength = 10;
			this.txtEntertainmentCategoryName.Name = "txtEntertainmentCategoryName";
			this.txtEntertainmentCategoryName.Size = new System.Drawing.Size(147, 27);
			this.txtEntertainmentCategoryName.TabIndex = 3;
			// 
			// label21
			// 
			...
			this.label21.Location = new System.Drawing.Point(6, 420);
			this.label21.Name = "label21";
			this.label21.Size = new System.Drawing.Size(55, 20);
			this.label21.TabIndex = 2;
			this.label21.Text = "Name:";
			// 
			// dgvEntertainmentCategory
			// 
			this.dgvEntertainmentCategory.AllowUserToAddRows = false;
			this.dgvEntertainmentCategory.AllowUserToDeleteRows = false;
			this.dgvEntertainmentCategory.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.dgvEntertainmentCategory.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.dgvEntertainmentCategory.Location = new System.Drawing.Point(0, 0);
			this.dgvEntertainmentCategory.MultiSelect = false;
			this.dgvEntertainmentCategory.Name = "dgvEntertainmentCategory";
			this.dgvEntertainmentCategory.ReadOnly = true;
			this.dgvEntertainmentCategory.RowHeadersWidth = 51;
			this.dgvEntertainmentCategory.RowTemplate.Height = 29;
			this.dgvEntertainmentCategory.SelectionMode = System.Windows.Forms.DataGridViewSelectionMode.FullRowSelect;
			this.dgvEntertainmentCategory.Size = new System.Drawing.Size(843, 372);
			this.dgvEntertainmentCategory.TabIndex = 1;
			this.dgvEntertainmentCategory.SelectionChanged += new System.EventHandler(this.dgvEntertainmentCategory_SelectionChanged);
			// 
			// tpgEntertainment
			// 
    ...
    "es.";
			...
			this.tpgAuthenticationService.ResumeLayout(false);
			this.tpgAuthenticationService.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvAuthenticationService)).EndInit();
			...
			this.tpgEntertainmentCategory.ResumeLayout(false);
			this.tpgEntertainmentCategory.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvEntertainmentCategory)).EndInit();
		...
		private TabPage tpgAuthenticationService;
		private TabPage tpgEntertainmentCategory;
		private TextBox txtEntertainmentCategoryName;
		private Label label21;
		private DataGridView dgvEntertainmentCategory;
		private CheckBox chkEntertainmentCategoryIsSport;
		private Button button1;
		private TextBox txtAuthenticationServiceWebsite;
		private TextBox txtAuthenticationServiceName;
		private Label label23;
		private Label label22;
		private DataGridView dgvAuthenticationService;
