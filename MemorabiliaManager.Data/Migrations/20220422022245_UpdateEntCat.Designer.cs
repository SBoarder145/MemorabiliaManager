...
namespace MemorabiliaManager.Data.Migrations
{
    ...
    [Migration("20220422022245_UpdateEntCat")]
    partial class UpdateEntCat
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MemorabiliaManager.Domain.Authentication", b =>
                {
                    ...
                    b.Property<int>("AuthenticationServiceId1")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("AuthenticationServiceId1");
            ...
            modelBuilder.Entity("MemorabiliaManager.Domain.AuthenticationService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MemorabiliaManager.Domain.Authentication", b =>
                {
                    b.HasOne("MemorabiliaManager.Domain.AuthenticationService", "AuthenticationService")
                        .WithMany()
                        .HasForeignKey("AuthenticationServiceId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("AuthenticationService");
